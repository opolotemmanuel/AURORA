...
- Provide 3-4 naturalRecommendations first. Each step must directly address this scan's visible photo findings (dimension bands and notes), profile primaryConcerns/skinGoals when relevant, and climate context — not generic wellness advice disconnected from what you observed. Cosmetic guidance only — no medical treatments or prescription actives.
